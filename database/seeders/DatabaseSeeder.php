...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // --- Team ---
        $imad = User::factory()->create(['name' => 'Imad', 'email' => 'imad@renovion.nl', 'role' => UserRole::Admin]);
        $raphael = User::factory()->create(['name' => 'Raphael', 'email' => 'raphael@renovion.nl', 'role' => UserRole::Admin]);
        $peter = User::factory()->create(['name' => 'Peter', 'email' => 'peter@renovion.nl', 'role' => UserRole::Vakman]);
        $mehmet = User::factory()->create(['name' => 'Mehmet', 'email' => 'mehmet@renovion.nl', 'role' => UserRole::Vakman]);
